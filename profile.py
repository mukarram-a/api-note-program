...
"""
DsuFileError is a custom exception handler. It is raised when 
attempting to load or save Profile objects to file the system.
...
"""
DsuProfileError is a custom exception handler. It is raised 
when attempting to deserialize a dsu file to a Profile object.
...
class Profile:
    """
    The Profile class exposes the properties required to join a DSU server.
